...
ESC 1.2.1 changes product names and icons while preserving installation identities and progress. Run `npm run check:release` after building to detect mismatched platform versions or metadata. Installer smoke tests use the new ESC executable display names.
